    ...
    switch (license) {
        ...
        case 'BSD-2-Clause':
            return {
                ...
                licenseUrl: '[License]: https://img.shields.io/badge/License-BSD%202--Clause-blue.svg',
            }
        case 'BSD-3-Clause':
            return {
                licenseBadge: '[![License][]](https://opensource.org/licenses/BSD-3-Clause)',
                licenseUrl: '[License]: https://img.shields.io/badge/License-BSD%203--Clause-blue.svg',
            }
        case 'BSD-4-Clause':
            return {
                licenseBadge: '[![License][]](https://opensource.org/licenses/)',
                licenseUrl: '[License]: https://img.shields.io/badge/License-BSD%204--Clause-blue.svg',
            }
        case 'GPL-2.0-only':
            return {
                licenseBadge: '[![License][]](https://www.gnu.org/licenses/old-licenses/gpl-2.0.en.html)',
